...
// function for merge sort for linked list
public Node mergeSortLinkedList(Node head){
    ...
    // slow is our mid
    // now we can divivde the linked list in 2 parts from mid
    Node rightHead=slow.next;
    slow.next=null;
    Node newLeft=mergeSortLinkedList(head);
    Node newRight=mergeSortLinkedList(rightHead);
